...
var c=0;
var name=names.forEach(function(char){
    if("z"==char[0]){
        c+=1;
    }  
})
...
var myarr=names.filter(function(arg){
    var firstletter=arg[0].toUpperCase()
    return (arg.includes("w") && firstletter==arg[0]);
})
console.log(myarr);

//4. Do all of the names contain vowels?
var vowels=["a","e","i","o","u"];
var vow=names.every(function(arr){
    arr=arr.split("");
...
var any=names.filter(function(name){
    if(name.length==2){
         return name;
        }      
})
...
var p=0;
var letter=names.forEach(function(arr){
    arr=arr.split("");
   var Names=arr.forEach(function(arg){
    if(arg=="z"){
        p+=1;
    }
})
...
var count=0;
var vowels=["a","e","i","o","u"];
var vow=arr.forEach(function(arg){
...
console.log(vowo("ramarao"));

//10. How many names have the maximum number of vowels that you found in the
//previous problem?
var max=names.map(function(arg){
    return vowo(arg);
})
//console.log(max);
var j=max.indexOf(Math.max(...max));
console.log(names[j]);